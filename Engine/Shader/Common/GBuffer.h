...
void EncodeGBufferData(MEGBufferData   InGBuffer,
...
void DecodeGBufferData(out MEGBufferData OutGBuffer, highp vec4 InGBufferA, highp vec4 InGBufferB, highp vec4 InGBufferC)
{
